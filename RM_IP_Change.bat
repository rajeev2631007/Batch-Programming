...
ECHO 2. Obtain WI-FI Delhi Office
ECHO 3. Change WI-FI Mahajan House Delhi-DHCP 
ECHO 4. Change WI-FI Mahajan House PNP-DHCP
ECHO 5. Exit
set choice=
...
netsh interface ip set address "Wi-Fi" static 192.168.1.89 255.255.255.0 192.168.1.254 1
...
netsh interface ip set address "Wi-Fi" static 192.168.2.89 255.255.255.0 192.168.2.50 1
netsh interface ipv4 set dnsservers "Wi-Fi" static 172.168.1.2 primary
netsh interface ipv4 add dnsservers "Wi-Fi" 8.8.8.8 index=2
goto end
